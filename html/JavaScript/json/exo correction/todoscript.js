"user strict";
/**
 * 1.   Créer une todo list. a chaque appui sur le bouton ajout,
 ...
 * 2.   le clique sur un élément de la liste lui ajoutera une classe qui aura por effet de barrer l'élément.
 * 3.   le clique sur la croix supprimera l'élément concerné.
 * 4.   sauvegarder la liste sauvegardé au chargement de la page.
