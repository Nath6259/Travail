...
// Je récupère le contexte dans lequel on travailler (certaines librairies permettent de faire de la 3D ou des animations poussées)
...
// strokeStyle change la couleur des lignes de canvas.
ctx.strokeStyle =  "red";
// là aussi que sur ceux qui suivent.
ctx.strokeRect(89, 54, 73, 129);
/**
 * Pour des formes plus complexe on va faire ceci:
 * On comence un chemin.
 */
ctx.beginPath();
// On déplace notre pointeur à une position (x,y)
ctx.moveTo(345,78);
// Je prévois jusqu'ou ma ligne devra être effectué.
ctx.lineTo(267, 12);
...
ctx.beginPath()
/**
 * arc() permet de dessiner des arc de cercle.
 ...
 * Si x plus le rayon du cercle plus grand que la largeur du canvas ou si x
 * moins le rayon du cercle plus petit que 0
 * alors vh égale à moins vh.
 * Si y plus le rayon du cercle plus grand que la largeur du canvas ou si y
 * moins le rayon du cercle plus petit que 0
...
let img = new Image();
// On luiajoute sa source.
img.src = "giant-cat-on-beach.jpg"
