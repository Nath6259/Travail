...
/*  
    Bien que plus rare, il est possible d'écrire une conditions en remplacant les
    accolades,
...
/* 
    ...
    nos conditions sous la forme de ternaire :
...
echo $pays[$r2], "<br>";
// le switch permet de gérer des cas sans avoir à faire des if et elseif en boucle.
switch($pays[$r2]){
    ...
    case "Japon":
        ...
        break;
    case "Suisse":
        echo "Pays ou tout le monde ne parle pas la même langue.";
    case "france":
        echo "met une majuscule";
        // si il n'y a pas de break, le cas suivant sera aussi effectué.
    case "France":
        echo "Second pays dont la cuisine est au patrimoinr immateriel de l'UNESCO.";
        break;
    default:
