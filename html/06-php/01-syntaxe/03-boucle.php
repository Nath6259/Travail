...
$x = 0;
// tant que la condition entre parenthèses est "true", l'action sera répété.
while($x < 5){
    echo $x, "<br>";
...
while($x <10):
    ...
    $x++;
endwhile;
// syntaxe ne pernant qu'une seule instruction :
while($x<15)
    echo $x++, "<br>";
#---------------------------------------------------------------------------------------
...
// Cet exemple se trouve dans un foreach mais continue et break sont 
//utilisable dans toute les boucles.
?>